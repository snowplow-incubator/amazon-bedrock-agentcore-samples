...
username = "testuser"
secret_name = "travel_agent"

role_name = f"TravelAgentAssistantBedrockAgentCoreRole-{REGION}"
policy_name = f"TravelAgentAssistantBedrockAgentCorePolicy-{REGION}"
...
def get_cognito_client_secret() -> str:
    ...
    response = client.describe_user_pool_client(
        UserPoolId=get_ssm_parameter("/app/travelagent/agentcore/userpool_id"),
        ClientId=get_ssm_parameter("/app/travelagent/agentcore/machine_client_id"),
    )
...
def save_travel_agent_secret(secret_value):
    ...
    try:
        secrets_client.create_secret(
            ...
            Description="Secret containing the Cognito Configuration for the Travel Agent",
        )
...
def delete_travel_agent_secret():
...
def setup_cognito_user_pool():
    ...
    try:
        ...
        save_travel_agent_secret(json.dumps(cognito_config))
...
def create_agentcore_runtime_execution_role():
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Resource": [
                    ...
                    f"arn:aws:bedrock-agentcore:{region}:{account_id}:workload-identity-directory/default/workload-identity/travel_agent-*",
                ],
            },
            {
    ...
    try:
        ...
        put_ssm_parameter(
            "/app/travelagent/agentcore/runtime_execution_role_arn",
...
def runtime_resource_cleanup():
    try:
        ...
        for repo in repositories['repositories']:
            if 'bedrock-agentcore-travel_agent' in repo['repositoryName']:
...
def delete_observability_resources():
    # Configuration
    log_group_name = "agents/travel-assistant-logs"
