...
# ----- Config -----
BUCKET_NAME=${1:-travelagent112}
INFRA_STACK_NAME=${2:-TravelAgentStackInfra}
COGNITO_STACK_NAME=${3:-TravelAgentStackCognito}
...
USER_POOL_NAME="TravelAgentGatewayPool" 
MACHINE_APP_CLIENT_NAME="TravelAgentMachineClient" 
WEB_APP_CLIENT_NAME="TravelAgentWebClient"
