...
def cli(ctx):
    ...
    Create and delete AgentCore memory resources for the travel agent application.
    """
...
@cli.command()
@click.option(
    "--name", default="TravelAgentMemory", help="Name of the memory resource"
)
@click.option(
    "--ssm-param",
    default="/app/travelagent/agentcore/memory_id",
    ...
    strategies = [
        {
            StrategyType.SEMANTIC.value: {
                ...
                "namespaces": ["travel/user/{actorId}/facts"],
            },
        },
        {
            StrategyType.SUMMARY.value: {
                ...
                "namespaces": ["travel/user/{actorId}/{sessionId}"],
            },
        },
        {
